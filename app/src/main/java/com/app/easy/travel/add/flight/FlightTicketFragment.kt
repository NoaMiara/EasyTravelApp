...
import com.app.easy.travel.databinding.FragmentFlightTicketBinding
...
class FlightTicketFragment : Fragment(), RecyclerViewInterface {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFlightTicketBinding.inflate(inflater, container, false)
        val root: View = binding.root
        recyclerview = binding.rvFlightTicket
        imageUpdate()
        return root
    }
    ...
    private fun imageUpdate() {
        recyclerview.apply {
            ...
            recyclerview.adapter = ImageRecyclerViewAdapter(imageData, this@FlightTicketFragment)
        }
    }
    ...
    override fun onResume() {
        super.onResume()
        imageManagement()
        binding.btnAddImageFlight.setOnClickListener {
            alertDialogForImage()
        }
    }
    ...
    private fun imageManagement() {
        if (imageData.isEmpty()) {
            ...
            binding.btnAddImageFlight.visibility = View.VISIBLE
        }
    ...
    private fun saveImageOnObj(selectedImageBitmap: Bitmap) {
        ...
        flight.file?.put(imageId,imageId)
    }
