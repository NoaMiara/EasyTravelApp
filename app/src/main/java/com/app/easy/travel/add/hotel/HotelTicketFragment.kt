...
class HotelTicketFragment : Fragment(), RecyclerViewInterface {

    private var _binding: FragmentHotelTicketBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHotelTicketBinding.inflate(inflater, container, false)
        val root: View = binding.root
        recyclerview = binding.rvHotelTicket
        imageUpdate()
        return root
    }
    ...
    private fun imageUpdate() {
        recyclerview.apply {
            ...
            recyclerview.adapter = ImageRecyclerViewAdapter(imageData, this@HotelTicketFragment)
        }
    }
    ...
    override fun onResume() {
        super.onResume()
        imageManagement()
        binding.btnAddImageHotel.setOnClickListener {
            alertDialogForImage()
        }
    ...
    private fun imageManagement() {
        if (imageData.isEmpty()) {
            ...
            binding.btnAddImageHotel.visibility = View.VISIBLE
        }
